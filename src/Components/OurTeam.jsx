          ...
          <div className="container p-4 mx-auto space-y-16 sm:p-10">
            <div className="space-y-4">
              ...
              <p className="max-w-2xl dark:text-gray-600">
                At Crafty Palette, we`re passionate about crafting
                innovative digital experiences that push the boundaries of web
                development. With a team of seasoned professionals, we
                specialize in creating bespoke websites that not only look
                stunning but also function seamlessly across all devices
              </p>
            </div>
